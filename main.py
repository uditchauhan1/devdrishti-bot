#!/usr/bin/env python3
"""
DevDrishti Bot - Razorpay Integration Version
...
class DevDrishtiRazorpayBot:
    ...
    def __init__(self):
        ...
        if not self.bot_token or not self.gemini_api_key:
            ...
            print("   Set BOT_TOKEN and GEMINI_API_KEY in your environment")
            print("   For Replit: Add them in the Secrets tab")
            sys.exit(1)
        ...
        if not self.razorpay_key_id or not self.razorpay_key_secret:
            ...
            print("   Set RAZORPAY_KEY_ID and RAZORPAY_KEY_SECRET in your environment")
